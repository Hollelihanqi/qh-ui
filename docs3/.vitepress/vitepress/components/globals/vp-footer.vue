...
<template>
  <footer class="footer" :class="{ 'is-home': isHome }">
    <div class="footer-main">
      <h4>{{ homeLang["10"] }}</h4>
      <a href="https://github.com/element-plus/element-plus" class="footer-main-link" target="_blank"> homeLang11 </a>
      ...
      <a href="https://element.eleme.io/" class="footer-main-link" target="_blank"> homeLang13 </a>
    </div>

    <div class="footer-main">
      <h4>{{ homeLang["19"] }}</h4>
      <a href="https://discord.com/invite/gXK9XNzW3X" class="footer-main-link" target="_blank"> homeLangdiscord </a>
      ...
      <a href="https://segmentfault.com/t/element-plus" class="footer-main-link" target="_blank"> homeLang18 </a>
    </div>
  </footer>
</template>
