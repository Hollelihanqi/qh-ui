        ...
        {},
        {
          get(_, key) {
            if (key !== '__esModule' && key !== '__proto__' && key !== 'constructor' && key !== 'splice') {
              console.warn(
                `Module "node:fs" has been externalized for browser compatibility. Cannot access "node:fs.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`,
              )
            }
          },
        },
      ...
      new Proxy(
        {},
        {
          get(_, key) {
            if (key !== '__esModule' && key !== '__proto__' && key !== 'constructor' && key !== 'splice') {
              console.warn(
                `Module "node:process" has been externalized for browser compatibility. Cannot access "node:process.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`,
              )
            }
          },
        },
...
// ../node_modules/.pnpm/rollup@4.24.4/node_modules/rollup/dist/native.js
var require_native = __commonJS({
  '../node_modules/.pnpm/rollup@4.24.4/node_modules/rollup/dist/native.js'(exports, module) {
    ...
    var requireWithFriendlyError = (id) => {
      try {
        ...
        if (
          ...
          error2.code === 'ERR_DLOPEN_FAILED' &&
          error2.message.includes('The specified module could not be found')
        ) {
      ...
      new Proxy(
        {},
        {
          get(_, key) {
            if (key !== '__esModule' && key !== '__proto__' && key !== 'constructor' && key !== 'splice') {
              console.warn(
                `Module "node:fs/promises" has been externalized for browser compatibility. Cannot access "node:fs/promises.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`,
              )
            }
          },
        },
      ...
      new Proxy(
        {},
        {
          get(_, key) {
            if (key !== '__esModule' && key !== '__proto__' && key !== 'constructor' && key !== 'splice') {
              console.warn(
                `Module "node:perf_hooks" has been externalized for browser compatibility. Cannot access "node:perf_hooks.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`,
              )
            }
          },
        },
      ...
      new Proxy(
        {},
        {
          get(_, key) {
            if (key !== '__esModule' && key !== '__proto__' && key !== 'constructor' && key !== 'splice') {
              console.warn(
                `Module "tty" has been externalized for browser compatibility. Cannot access "tty.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`,
              )
            }
          },
        },
...
// ../node_modules/.pnpm/rollup@4.24.4/node_modules/rollup/dist/es/shared/parseAst.js
...
function getCodeFrame(source, line, column) {
  ...
  const maxLineLength = Math.max(
    tabsToSpaces(lines[line - 1].slice(0, column)).length + MIN_CHARACTERS_SHOWN_AFTER_LOCATION + ELLIPSIS.length,
...
function getImportPath(importerId, targetPath, stripJsExtension, ensureFileName) {
  ...
  if (ensureFileName) {
    if (relativePath === '') return '../' + (0, import_node_path.basename)(targetPath)
...
var parseAst = (input, { allowReturnOutsideFunction = false, jsx = false } = {}) =>
  convertProgram(getAstBuffer((0, import_native.parse)(input, allowReturnOutsideFunction, jsx)))
...
rollup/dist/es/shared/parseAst.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-RCZZDYYZ.js.map
