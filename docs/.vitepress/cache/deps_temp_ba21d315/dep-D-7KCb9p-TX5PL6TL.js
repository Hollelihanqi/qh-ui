...
// ../node_modules/.pnpm/vite@5.4.10_@types+node@18.19.50_sass@1.83.4/node_modules/vite/dist/node/chunks/dep-D-7KCb9p.js
...
function endTagAfterBody(p, token) {
  ...
  if (token.tagID === TAG_ID.HTML) {
    ...
    if (p.options.sourceCodeLocationInfo && p.openElements.tagIDs[0] === TAG_ID.HTML) {
      ...
      if (
        bodyElement &&
        !((_a = p.treeAdapter.getNodeSourceCodeLocation(bodyElement)) === null || _a === void 0 ? void 0 : _a.endTag)
      ) {
        p._setEndLocation(bodyElement, token)
      }
    }
...
//# sourceMappingURL=dep-D-7KCb9p-TX5PL6TL.js.map
