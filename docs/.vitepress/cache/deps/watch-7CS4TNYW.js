...
// ../node_modules/.pnpm/rollup@4.24.4/node_modules/rollup/dist/es/shared/watch.js
...
function requireFseventsHandler() {
  ...
  const wrongEventFlags = /* @__PURE__ */ new Set([69888, 70400, 71424, 72704, 73472, 131328, 131840, 262912])
          ...
          this.fsw
            ...
            .on(STR_DATA, (entry) => {
              ...
              if (wh.followSymlinks && entry.stats.isSymbolicLink()) {
                const curDepth =
                  opts.depth === void 0 ? void 0 : calcDepth(joinedPath, sysPath.resolve(wh.watchPath)) + 1
...
function requireChokidar() {
  ...
  class WatchHelper {
    ...
    filterPath(entry) {
      ...
      const matchesGlob =
        this.hasGlob && typeof this.globFilter === FUNCTION_TYPE ? this.globFilter(resolvedPath) : true
    ...
    _isIgnored(path2, stats) {
      ...
      if (!this._userIgnored) {
        ...
        const paths = arrify(ignored)
          .filter((path3) => typeof path3 === STRING_TYPE && !isGlob2(path3))
          .map((path3) => path3 + SLASH_GLOBSTAR)
...
var Task = class {
  constructor(watcher, options) {
    ...
    this.outputFiles = this.outputs.map((output) => {
      if (output.file || output.dir) return import_node_path.default.resolve(output.file || output.dir)
      return void 0
    })
...
rollup/dist/es/shared/watch.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=watch-7CS4TNYW.js.map
