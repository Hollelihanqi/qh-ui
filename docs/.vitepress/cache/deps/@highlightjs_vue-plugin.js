import { computed, defineComponent, h, ref, watch } from './chunk-B3ROQUUI.js'
import './chunk-JVSYCCQQ.js'
import { require_core } from './chunk-YIPPYU3N.js'
...
// ../node_modules/.pnpm/@highlightjs+vue-plugin@2.1.0_highlight.js@11.11.1_vue@3.5.13_typescript@5.6.3_/node_modules/@highlightjs/vue-plugin/dist/highlightjs-vue.esm.min.js
  ...
  setup: function (e) {
    ...
    return {
      ...
      highlightedCode: computed(function () {
        ...
        if (o2.value)
          return (
            console.warn('The language "' + n.value + '" you specified could not be found.'),
            e.code
              .replace(/&/g, '&amp;')
              .replace(/</g, '&lt;')
              .replace(/>/g, '&gt;')
...
export { highlightjs_vue_esm_min_default as default }
