...
import { buildOutput, ytoCustomRoot, excludeFiles, pkgRoot, projRoot } from '@yto-custom/build-utils'
...
async function addSourceFiles(project: Project) {
  ...
  await Promise.all([
    ...
    ...epPaths.map(async (file) => {
      const content = await readFile(path.resolve(ytoCustomRoot, file), 'utf-8')
