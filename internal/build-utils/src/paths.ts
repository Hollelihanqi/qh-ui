...
export const ytoCustomRoot = resolve(pkgRoot, 'yto-custom')
...
/** `/dist/yto-custom` */
export const ytoOutput = resolve(buildOutput, 'yto-custom')
...
export const ytoPackage = resolve(ytoCustomRoot, 'package.json')
