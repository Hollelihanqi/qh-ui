import { YtoAdaptionContainer } from '@yto-custom/components/adaption-container'
import { YtoCustomFieldConfig } from '@yto-custom/components/custom-field-config'
...
export default [
  YtoAdaptionContainer,
  YtoCustomFieldConfig,
