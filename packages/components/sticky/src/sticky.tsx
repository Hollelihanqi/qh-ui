import { defineComponent, ref, reactive, computed, watch, onMounted, unref, Ref, CSSProperties } from 'vue'
import { stickyProps, stickyEmits } from './isticky'
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    return () => (
      <div ref={root} style={rootStyle.value} class="yto-sticky">
